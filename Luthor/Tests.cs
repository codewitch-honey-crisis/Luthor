...
namespace Luthor
{
    internal class Tests
    {
        ...
        {
            (string Text, bool Expectation)[] inputs =
            {
                ("aaabababb",true),
                ("/* foo */",true),
                ("fubar",true),
            ...
            try
            {
                ...
                foreach (var input in inputs) TestDfaUtf32(dfa, input.Text,input.Expectation);
                ...
                // Test the DFA with some strings
                foreach (var input in inputs) TestDfaUtf16(utf16dfa, input.Text,input.Expectation);
                ...
                // Test the DFA with some strings
                foreach (var input in inputs) TestDfaUtf8(utf8dfa, input.Text,input.Expectation);
        ...
        static void TestDfaUtf32(Dfa startState, string input, bool expectationToPass = true)
        {
        ...
        static void TestDfaUtf16(Dfa startState, string input, bool expectationToPass = true)
        {
        ...
        static void TestDfaUtf8(Dfa startState, string input, bool expectationToPass = true)
        {
